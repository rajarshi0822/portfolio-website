    ...
    <>
      <style>{`
        .nav-pill {
          ...
          border-radius: 999px;
          padding: 5px 8px;
          box-shadow: 0 4px 30px rgba(0,0,0,0.5), 0 0 0 1px rgba(255,255,255,0.03) inset;
          transition: all 0.3s ease;
        }
        .nav-pill:hover {
          border-color: rgba(124,58,237,0.35);
          box-shadow: 0 8px 40px rgba(124,58,237,0.15), 0 0 30px rgba(124,58,237,0.05), 0 0 0 1px rgba(255,255,255,0.05) inset;
        }
        .nav-link {
        ...
        .nav-link.active {
          ...
          box-shadow: 0 2px 14px rgba(124,58,237,0.4), 0 0 20px rgba(124,58,237,0.1);
        }
        .nav-divider {
